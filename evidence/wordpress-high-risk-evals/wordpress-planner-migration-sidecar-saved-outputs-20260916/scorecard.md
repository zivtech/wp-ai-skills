...
Run ID: `wordpress-planner-migration-sidecar-saved-outputs-20260916`
Suite: `wordpress-planner.migration`
Skill: `wordpress-planner.migration`
Run directory: `evals/results/wordpress-planner-migration-sidecar-saved-outputs-20260916`
...
| --- | ---: | ---: | ---: |
| `baseline-few-shot` | 1 | 1 | 0 |
| `baseline-zero-shot` | 1 | 1 | 0 |
| `skill` | 1 | 1 | 0 |
...
- Focused skill contracts pass: `0/1`
- All focused skill contracts pass: `false`
