...
| Migration planner host-sync sidecar contract | `evidence/wordpress-high-risk-evals/wordpress-planner-migration-sidecar-saved-outputs-20260916/scorecard.md`; `evidence/wordpress-high-risk-evals/wordpress-planner-migration-sidecar-saved-outputs-20260916/contract-summary.json` | The first fixture scored with a per-fixture capability manifest: all three lanes generated and all three failed the contract, the skill lane only on sync-confirmation records, both baselines on ungrounded or unconfirmed sync tools. | A quality edge, a fixed skill, or anything beyond one output per lane. |
| Blueprint executor Studio sidecar contract | `evidence/wordpress-high-risk-evals/wordpress-blueprint-executor-sidecar-saved-outputs-20260916/scorecard.md`; `evidence/wordpress-high-risk-evals/wordpress-blueprint-executor-sidecar-saved-outputs-20260916/contract-summary.json` | The first executor fixture scored with a per-fixture capability manifest in single-stage executor-direct mode: all three lanes generated and all three failed, every lane on the superseded standalone `studio-mcp`, the skill lane additionally on packet headings, a bare `wp` under a `studio wp` prefix, and unconfirmed Studio sync tools. | A quality edge, a fixed skill, Playground or Studio launch behavior, or anything beyond one output per lane. |
